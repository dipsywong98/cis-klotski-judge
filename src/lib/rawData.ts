const data1 = [
  ...
  },
  {
    ...
    board: "AA@NAA@OBBPHICCHIQDD",
    empty: 2,
  },
]

const MY_HOME = "\u543e\u5c45\u7121\u675f",
  MY_URL = "http://simonsays-tw.com",
  data2 = [
    {
      name: "Level 01",
      mini: 25,
...
export const rawData = [...data1, ...data2, ...data3, ...data4] as const
